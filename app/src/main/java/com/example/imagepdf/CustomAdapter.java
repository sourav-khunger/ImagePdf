...
public class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(Context c, ArrayList<PDFDoc> pdfDocs, boolean showCheckBox, ImageView selected_share_pdf, ImageView hide_checkBox) {
        this.c = c;
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (isChecked) {
                    ...
                    File filelocation = new File(Environment.getExternalStorageDirectory() + "/KABACK FORMS/", filename);
